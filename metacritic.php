...
<head>
    ...
    <link rel='stylesheet' href='amiibo_e_metacritic.css'>
    <script src="metacritic.js" defer></script>
    ...
    <title>GameCorner - Metacritic </title>
...
<div id="menu">
    ...
    <form id='form'>
        <div class="ricerca"> 
        Punteggi Metacritic dei videogiochi:
            <div id="lente_e_barra">
           <input type='submit' id="lente" value=''> 
           <input type='text' id='barradiricerca' name='barradiricerca'  placeholder="Digita qualcosa...">
    </div>
         </div>
    </form>
