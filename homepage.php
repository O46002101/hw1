...
<div id="menu">
    ...
    <section>
        ...
        <div class="links">
            ...
            <a href="videogiochi_popolari.php" class="button">Scopri di più</a>
        ...
        <div id="curiosita">
            ...
            <span id="amiibo"> <a href="amiibo.php" class="button">Trova il tuo amiibo</a></span>
            <span id="metacritic"> <a href="metacritic.php" class="button">Punteggi Metacritic</a></span>
